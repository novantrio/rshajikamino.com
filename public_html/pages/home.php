           ...
           <div class="row">
                ...
                <?php
                    if(!isset($_SESSION["dokter"])){
                        $delay          = 0.2;
                        $datadokter     = "";
                        $querydokter=bukaquery("select dokter.kd_dokter,left(dokter.nm_dokter,40) as dokter,spesialis.nm_sps,dokter.no_ijn_praktek,pegawai.photo,dokter.no_telp from dokter inner join spesialis on dokter.kd_sps=spesialis.kd_sps inner join pegawai on dokter.kd_dokter=pegawai.nik where dokter.status='1' and dokter.kd_dokter<>'-' group by spesialis.nm_sps limit 5");
                        while($rsquerydokter = mysqli_fetch_array($querydokter)) {
                            $datadokter=$datadokter.
                               "<div class='col-md-4 col-sm-6'>
                                    <div class='team-thumb wow fadeInUp' data-wow-delay='".$delay."s'>
                                             <img alt='Photo' src='images/$rsquerydokter[4]' class='img-responsive' />
                                          <div class='team-info'>
                ...
                <div class="col-md-6 col-sm-6">
                     <form id="appointment-form" role="form" onsubmit="return validasiIsi();" method="post" action="index.php?act=PendaftaranPeriksa" enctype=multipart/form-data>
                          ...
                          <!-- <h2><center>Buat Janji/Booking</center></h2>
                               ...
                               <div class="col-md-12 col-sm-12">
                                   <label>Sudah pernah periksa sebelumnya? Silahkan <br><a href="index.php?act=LoginPasien" class="btn btn-success">Log In</a></label><br/><br/>
                               </div>
                          </div>
                    </form>
                </div> 
