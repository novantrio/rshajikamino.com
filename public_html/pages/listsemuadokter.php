           ...
           <div class="row">
                ...
                <?php
                    if(!isset($_SESSION["semuadokter"])){
                        $datadokter       = "";
                        $querysemuadokter = bukaquery("select dokter.kd_dokter,left(dokter.nm_dokter,40) as dokter,spesialis.nm_sps,dokter.no_ijn_praktek,pegawai.photo,dokter.no_telp from dokter inner join spesialis on dokter.kd_sps=spesialis.kd_sps inner join pegawai on dokter.kd_dokter=pegawai.nik where dokter.status='1' and dokter.kd_dokter<>'-' order by spesialis.nm_sps");
                        while($rsquerysemuadokter = mysqli_fetch_array($querysemuadokter)) {
                            $datadokter=$datadokter.
                                    "<div class='col-md-4 col-sm-6'>
                                        <div class='team-thumb wow fadeInUp' data-wow-delay='0.2s'>
                                             <img alt='Photo' src='https://webapps.rshajikamino.com/penggajian/$rsquerysemuadokter[4]' class='img-responsive' />
                                              <div class='team-info'>
