<?php
    ...
    $db_hostname            = "ip-server";
    $db_username            = "nama-database";
    $db_password            = "passwd-database";
    $db_name                = "nama-database";
    define('URUTNOREG', 'poli-jkn'); // dokter / poli / dokter + poli
    $month          = date('Y-m');
    $date           = date('Y-m-d');
    $time           = date('H:i:s');
    ...
    function encrypt_decrypt($string,$action){
        $secret_key     = 'v^Pm0&oK%26o$'; 
        $secret_iv      = 'vhD8V5Xm!bu9&$1T';
        $output         = FALSE;
