...
<!--     <meta name="robots" content="index,follow"> -->
     ...
     <meta name="keywords" content="epasien, layanan, kesehatan, rumah sakit haji kamino"/>
          ...
          <div class="container">
               <div class="row">
                    <div class="col-md-4 col-sm-5">
                         <p>Selamat datang di <?=htmlspecialchars($_SESSION["nama_instansi"]);?></p>
                    </div>
                    <div class="col-md-8 col-sm-7 text-align-right">
                         <span class="phone-icon"><i class="fa fa-phone"></i> <a href="tel://<?=$_SESSION["kontak"];?>"><?=$_SESSION["kontak"];?></a></span>
                         <span class="date-icon"><i class="fa fa-calendar-plus-o"></i> 06:00 - 22:00 (Senin-Sabtu)</span>
                         <span class="email-icon"><i class="fa fa-envelope-o"></i> <a href="mailto:<?=$_SESSION["email"];?>"><?=$_SESSION["email"];?></a></span>
                    </div>
               </div>
          </div>
     </header>
                    ...
                    <div class="col-md-4 col-sm-4">
                         <div class="footer-thumb"> 
                              ...
                              <div class="contact-info">
                                   <p><i class="fa fa-phone"></i> <a href="tel://<?=$_SESSION["kontak"];?>"><?=$_SESSION["kontak"];?></a>
                                   <p><i class="fa fa-envelope-o"></i> <a href="mailto:<?=$_SESSION["email"];?>"><?=$_SESSION["email"];?></a></p>
                              </div>
                         </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4"> 
                         <div class="footer-thumb">
                              ...
                              <ul class="social-icon">
                                   <li><a href="https://www.facebook.com/people/RS-hajikamino/100064127621738/" class="fa fa-facebook-square" attr="facebook icon"></a></li>
                                   <li><a href="#" class="fa fa-youtube"></a></li>
                                   <li><a href="https://www.instagram.com/rshajikamino/?hl=id" class="fa fa-instagram"></a></li>
                              </ul>
                         </div>
                    </div>
